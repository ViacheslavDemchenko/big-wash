...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return sliderAbout; });
...
function sliderAbout() {
  if (document.querySelector('.about__slider')) {
    var swiper = new _libs_swiper_bundle_min_js__WEBPACK_IMPORTED_MODULE_0___default.a('.about__slider', {
      spaceBetween: 0,
      loopedSlides: 1,
      slidesPerView: 1,
      loop: true,
